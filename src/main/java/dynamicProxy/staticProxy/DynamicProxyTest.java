...
public class DynamicProxyTest {
    ...
    private static void createProxy() throws Exception {
        ...
        //设置Field
        CtField field = CtField.make("private dynamicProxy.staticProxy.Station station;", cc);

        cc.addField(field);

        CtClass stationClass = pool.get("dynamicProxy.staticProxy.Station");
        ...
        cc.writeFile(DynamicProxyTest.class.getResource("").getPath());
    }
}
